...
const autoDetectCategory = (kind: InputKind, description: string, value: number ) => {
  ...
  if(description === "MAX STOCKHOLM") return "HBO"
  if(description.startsWith("SPOTIFY ")) return "HBO"
  ...
  if(description === "GOOGLE *GOOGLE ONE G.CO/HELPPAY#") return "Google (lagring)"
  ...
  if(description === "NORRTÄLJE VATTEN OCH AVF") return "VA"
  if(description === "LÅN 41744138") return "Amortering + ränta (lägenhet)"
  if(description === "LÅN 41744111") return "Amortering + ränta (lägenhet)"
  if(description === "LÅN 41744103") return "Amortering + ränta (lägenhet)"
  if(description === "LÅN 41744081") return "Amortering + ränta (lägenhet)"
  ...
  if(description === "PENSION SEB" && kind === InputKind.SEB) return "Insättning Caroline - Lön"
